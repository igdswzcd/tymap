...
function initRuntimeSocketService() {
  const hosts = "10.66.27.7,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_0g18Rc";
...
const b = true, k = "mp-weixin", E = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), A = k, P = T('{"address":["127.0.0.1","10.66.27.7"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","D:/sakana/uniapp/HBuilderX/plugins/unicloud/**/*.js"]}'), C = T('[{"provider":"aliyun","spaceName":"tymap","spaceId":"mp-4ffabeb4-3aba-48a3-b9b8-564890fc0fcf","clientSecret":"5GGKDBIXX5bEFsFgQvDCyg==","endpoint":"https://api.next.bspapp.com"}]') || [];
let x = "";
try {
  x = "__UNI__E450920";
} catch (e2) {
